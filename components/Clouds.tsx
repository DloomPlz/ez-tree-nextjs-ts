...
export class Clouds extends THREE.Mesh {
  private cloudShader: CloudShader | null = null
  ...
  constructor() {
    ...
    this.material.onBeforeCompile = (shader) => {
      const cloudShader = shader as unknown as CloudShader
  ...
  update(elapsedTime: number): void {
    if (this.cloudShader) {
      this.cloudShader.uniforms.uTime.value = elapsedTime
    }
  }
}
